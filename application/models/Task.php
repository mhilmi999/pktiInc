...
class Task extends CI_Model
{
   ...
   function insertNewTask($id_peserta = 0, $filename = '')
   {
      $this->db->set("judul", $this->input->post('judul'));
      $this->db->set("file_location", $filename);

      $this->db->set("id_peserta", $id_peserta);
   ...
   function getMyTask($id_user = -1)
   {
      ...
      JOIN assignment t2 ON t1.id_task = t2.id_task JOIN peserta t3 ON t1.id_peserta = t3.id_user 
