              ...
              <div class="tagline_text">
                ...
                <?= $this->session->flashdata('message');?>
                  <div class="row no-gutters">
                        ...
                        <div margin ="20px" class="text-center">
								          <a  margin ="20px" class="btn btn-secondary" href="<?= base_url('index.php/AccountCtl/editProfile'); ?>">Edit Profile</a>
							          </div>
                        <div margin ="20px" class="text-center">
								          <a  class="btn btn-secondary" href="<?= base_url('index.php'); ?>/AccountCtl/changePassword">Change Password</a>
							          </div>
                  </div>
            </div>
          </div>
