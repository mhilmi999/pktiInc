            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?= base_url() . 'index.php/EditorCtl'; ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                  <ul class="dropdown-menu">
                    <li><a href="<?= base_url() . 'index.php/EditorCtl/addTask'; ?>">Add Task</a></li>
                    <li><a href="<?= base_url() . 'index.php/EditorCtl/viewTask'; ?>">View Tasks</a></li>
                  </ul>
                </li>
                <li class="dropdown">
