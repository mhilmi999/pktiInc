            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?php echo base_url() . 'index.php/reviewerCtl/index'; ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() . 'index.php/reviewerCtl/taskrequest'; ?>">Task Request</a></li>
                    <li><a href="<?php echo base_url() . 'index.php/reviewerCtl/viewTask'; ?>">View Task</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#">Finance</a>
                  <ul class="dropdown-menu">
                    <li><a href="#">Rp.<?= $saldo[0]['saldo']; ?></a></li>
                    <li><a href="<?php echo base_url() . 'index.php/reviewerCtl/deductFund'; ?>">Deduct Fund</a></li>
                  </ul>
                </li>
                <li class="dropdown">
