 ...
 <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          ...
          <span>Copyright &copy; by PKTI.Inc (<strong>mhilmi999</strong>)</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <!-- Page level plugins -->
  <script src="<?= base_url(); ?>asset2/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?= base_url(); ?>asset2/js/demo/chart-area-demo.js"></script>
  <script src="<?= base_url(); ?>asset2/js/demo/chart-pie-demo.js"></script>
