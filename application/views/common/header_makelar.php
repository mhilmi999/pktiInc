              ...
              <ul class="nav topnav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() . 'index.php/makelaarCtl/getViewNewTask'; ?>">View New Task</a></li>
                    <li><a href="<?php echo base_url() . 'index.php/makelaarCtl/getViewOnGoingtask'; ?>">View On Going Task</a></li>
                    <li><a href="<?php echo base_url() . 'index.php/makelaarCtl/getViewCompletedtask'; ?>">View Completed Task</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#"><?php echo $nama_user; ?></a>
                  <ul class="dropdown-menu">
                    <li><a ><?php echo $current_role ?></a></li>
